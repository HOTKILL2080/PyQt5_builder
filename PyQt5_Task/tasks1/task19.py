...
lab = app.widget_create('lab', 'lab', 50, 25, 0, 0, '0')
s = app.widget_create('btn', 'S', 25, 25, 0, 0, 'S')
v = app.widget_create('btn', 'V', 25, 25, 0, 0, 'V')
a = app.widget_create('ted', 'ted', 50, 25, 200, 200, '')
