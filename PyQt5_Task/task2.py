...
def window():
    ...
    btn_p.clicked.connect(lambda: perimeter(edit, label))
...
def perimeter(edit, label):
    value = int(edit.toPlainText()) * 4
    label.setText(str(value))


def square(edit, label):
    value = int(edit.toPlainText()) ** 2
    label.setText(str(value))
